<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="Izdavac, App_Web_qmr5xzfl" %>
...
<link href="Styles/demo_page.css" rel="stylesheet" type="text/css" />
    ...
    <script src="Scripts/Izdavac.js" type="text/javascript"></script>
...
<div id="dialog-form" title="Dodaj novi zanr">
    ...
    <div style="width:100px;float:left;text-align:left">
		<label id="lbName"for="jmbg">Издавач:</label>
    </div>
    <div style="width:400px;float:left;text-align:left">
		<input type="text" name="izdavac" id="izdavac" class="text ui-widget-content ui-corner-all" style="width:400px" />
   </div>
	</fieldset>
...
<div id="center">
    ...
    <div class="dodaj">
        <button id="dodajNovi" style="width:150px" type="button">Додај новог</button>
    </div>
     </div>
