        ...
        */
        function classSettings() {
            ...
            */
            this.oLanguage = {
                "sProcessing": "Sačekaj...",
                "sLengthMenu": "Прикажи _MENU_ редова",
                "sZeroRecords": "Није пронађен ниједан запис",
                "sEmptyTable": "Нема података у табели",
                "sInfo": "Приказано _START_ до _END_ од _TOTAL_ редова",
                "sInfoEmpty": "Приказано 0 до 0 од 0 редова",
                "sInfoFiltered": "(traženo nad _MAX_ redova)",
                "sInfoPostFix": "",
                "sSearch": "Претражи:",
                "sUrl": "",
                "oPaginate": {
